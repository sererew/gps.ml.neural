...
3. Guarda los resultados en data/filtered/<filtro>/<pasada>/
...
Uso:
    ...
    python 8_apply_all_filters.py --pasadas 1,2,3
    python 8_apply_all_filters.py --filtros nn,kalman,savgol
...
def create_output_path(filter_name, pasada, input_file):
    ...
    # Ruta de salida: data/filtered/<filtro>/<pasada>/
    output_dir = os.path.join("data", "filtered", filter_name, pasada)
