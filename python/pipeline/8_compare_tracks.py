...
Uso:
    python 8_compare_tracks.py
    python 8_compare_tracks.py --pasadas 1,2,3
    python 8_compare_tracks.py --output results.xlsx
"""
...
def find_all_filtered_tracks(filtered_dir):
    ...
    # Search structure: results/filtered/<filter>/<pass>/*.gpx
