...
/**
 * Represents the results of a single LOFO fold, comparing neural network vs
...
public class LofoResult {
	...
	public LofoResult(String familyName, double neuralNetworkMAE,
			double baselineMAE, double[] neuralNetworkDetails,
			double[] baselineDetails) {
	...
	/**
	 * Calculates the improvement of neural network over baseline. Positive
	 * values indicate neural network is better (lower MAE).
	 */
	...
	public String toString() {
		return String.format(
				"LofoResult{family='%s', NN=%.3f, Baseline=%.3f, Improvement=%.1f%%}",
				familyName, neuralNetworkMAE, baselineMAE,
